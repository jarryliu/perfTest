...
for pktlen in pktLenList:
	...
	for i in range(len(intervals)):
		...
		os.system("./client 10.0.0.27 1100 "+str(stopCounts[i])+" "+str(pktlen)+ " " + str(intervals[i]) + " > tcplog/tcp_"+str(pktlen)+"_"+str(intervals[i]) + " &")
		time.sleep(1)
		os.system("python measure.py -n client -t 0")
		time.sleep(5)
		print("\n")
	print("\n")
